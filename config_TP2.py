...
import robot_randomsearchcases
...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_randomsearchcases.Robot_player(4, y_center, 0, name="My Robot", team="A",evaluations=evaluations,it_per_evaluation=it_per_evaluation)) # start from left: 4, y_center
    return robots
