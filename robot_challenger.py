...
class Robot_player(Robot):
    ...
    def strategy1(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
    ...
    def strategy2(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
